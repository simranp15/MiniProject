...
namespace Question_1_Mvc.Models
{
    using System;
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int Employee(string ename, ObjectParameter jb)
        {
            var enameParameter = ename != null ?
                new ObjectParameter("ename", ename) :
                new ObjectParameter("ename", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Employee", enameParameter, jb);
        }
